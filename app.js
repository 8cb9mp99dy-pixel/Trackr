...
/* Single source of truth for budget categories — used both to seed defaultData() (fresh
   ...
   Built around a student's real money flows (family support, grants/scholarships, part-time and
   gig work, housing aid, study costs, going out, travel/exchange) — deliberately broad, since an
   unused subcategory costs nothing but a missing one forces a miscategorized transaction. */
const _sc = (id, name, icon) => ({ id, name, icon });
const BUDGET_CATEGORIES_TEMPLATE = {
  income: [
    { id: 'inc_salary', name: 'Salary', icon: '💼', subcategories: [
      _sc('sci_parttime', 'Part-time Job', '🧑‍🍳'), _sc('sci_campusjob', 'Campus / Student Job', '🏫'),
      _sc('sci_internship', 'Internship Pay', '🧑‍💼'), _sc('sci_summerjob', 'Summer Job', '☀️'),
      _sc('sci_apprentice', 'Apprenticeship / Work-study Pay', '🛠️'), _sc('sci_bonus', 'Bonus & Overtime', '💶'),
      _sc('sci_holidaypay', 'Holiday Pay', '🏖️'),
    ] },
    { id: 'inc_freelance', name: 'Freelance', icon: '🧑‍💻', subcategories: [
      _sc('sci_tutoring', 'Tutoring & Private Lessons', '🧑‍🏫'), _sc('sci_freelanceprojects', 'Freelance Projects', '💻'),
      _sc('sci_gigwork', 'Gig Work (Delivery / Rides)', '🛵'), _sc('sci_babysitting', 'Babysitting', '🍼'),
      _sc('sci_petsitting', 'Pet Sitting & Dog Walking', '🐕'), _sc('sci_surveys', 'Surveys & Paid Studies', '📝'),
      _sc('sci_translation', 'Translation & Writing', '🌐'), _sc('sci_creative', 'Design / Photo / Video', '🎨'),
      _sc('sci_eventwork', 'Event & Promo Work', '🎪'),
    ] },
    { id: 'inc_family', name: 'Family Support', icon: '👪', subcategories: [
      _sc('sci_allowance', 'Monthly Allowance', '💶'), _sc('sci_familyrent', 'Rent Contribution', '🏠'),
      _sc('sci_familytuition', 'Tuition Contribution', '🎓'), _sc('sci_familyoneoff', 'One-off Help', '🤝'),
      _sc('sci_familygroceries', 'Groceries / Bills Paid by Family', '🛒'),
    ] },
    { id: 'inc_grants', name: 'Scholarships & Grants', icon: '🎓', subcategories: [
      _sc('sci_govgrant', 'Government Study Grant', '🏛️'), _sc('sci_meritschol', 'Merit Scholarship', '🏆'),
      _sc('sci_needschol', 'Need-based Scholarship', '🤲'), _sc('sci_bursary', 'University Bursary', '🏫'),
      _sc('sci_erasmus', 'Erasmus / Exchange Grant', '✈️'), _sc('sci_researchgrant', 'Research / Thesis Grant', '🔬'),
      _sc('sci_foundation', 'Foundation / Company Scholarship', '🏢'), _sc('sci_stipend', 'Stipend / Fellowship', '📜'),
    ] },
    { id: 'inc_benefits', name: 'Government Benefits', icon: '🏛️', subcategories: [
      _sc('sci_housingaid', 'Housing Allowance / Rent Aid', '🏠'), _sc('sci_familyallowance', 'Family / Child Allowance', '👨‍👩‍👧'),
      _sc('sci_transitsubsidy', 'Transport Subsidy', '🚌'), _sc('sci_mealsubsidy', 'Meal Subsidy', '🍱'),
      _sc('sci_healthsubsidy', 'Health Insurance Subsidy', '🩺'), _sc('sci_jobseeker', 'Job-seeker Benefit', '🔎'),
    ] },
    { id: 'inc_loans', name: 'Student Loans & Credit', icon: '🏦', subcategories: [
      _sc('sci_studentloan', 'Student Loan Disbursement', '🎓'), _sc('sci_aidrefund', 'Financial Aid Refund', '↩️'),
      _sc('sci_emergencyloan', 'Emergency / Hardship Loan', '🆘'), _sc('sci_familyloan', 'Loan from Family / Friends', '🤝'),
    ] },
    { id: 'inc_invret', name: 'Investment Returns', icon: '📈', subcategories: [
      _sc('sci_dividends', 'Dividends', '💵'), _sc('sci_interest', 'Interest', '🏦'),
      _sc('sci_capgains', 'Capital Gains', '📈'), _sc('sci_crypto', 'Crypto Gains & Staking', '🪙'),
    ] },
    { id: 'inc_rental', name: 'Rental Income', icon: '🏠', subcategories: [
      _sc('sci_subletting', 'Room / Subletting', '🛏️'), _sc('sci_shorttermrental', 'Short-term Rental', '🧳'),
      _sc('sci_parkingrental', 'Parking / Storage Rental', '🅿️'),
    ] },
    { id: 'inc_sales', name: 'Sales & Resale', icon: '🏷️', subcategories: [
      _sc('sci_sellbooks', 'Used Textbooks', '📚'), _sc('sci_sellclothes', 'Second-hand Clothes', '👕'),
      _sc('sci_sellelectronics', 'Electronics', '📱'), _sc('sci_sellfurniture', 'Furniture & Home', '🛋️'),
      _sc('sci_selltickets', 'Tickets & Events', '🎫'), _sc('sci_sellbike', 'Bike / Vehicle', '🚲'),
    ] },
    { id: 'inc_refunds', name: 'Refunds & Reimbursements', icon: '↩️', subcategories: [
      _sc('sci_taxrefund', 'Tax Refund', '🧾'), _sc('sci_depositrefund', 'Rental Deposit Refund', '🔑'),
      _sc('sci_cashback', 'Cashback & Rewards', '💳'), _sc('sci_expensereimb', 'Expense Reimbursement', '🧾'),
      _sc('sci_insurancepayout', 'Insurance Payout', '🛡️'), _sc('sci_friendrepay', 'Friends Paying Me Back', '🍕'),
      _sc('sci_healthreimb', 'Health Reimbursement', '🩺'), _sc('sci_purchaserefund', 'Returned Purchase', '📦'),
    ] },
    { id: 'inc_gifts', name: 'Gifts Received', icon: '🎁', subcategories: [
      _sc('sci_birthday', 'Birthday Money', '🎂'), _sc('sci_holidaygift', 'Holiday Money', '🎄'),
      _sc('sci_graduationgift', 'Graduation Gift', '🎓'), _sc('sci_giftcards', 'Gift Cards', '💳'),
    ] },
    { id: 'inc_other', name: 'Other', icon: '💰', subcategories: [
      _sc('sci_prizes', 'Prizes & Competitions', '🏆'), _sc('sci_lostfound', 'Found / Returned Money', '🍀'),
      _sc('sci_misc', 'Miscellaneous', '❔'),
    ] },
  ],
  expense: [
    { id: 'exp_housing', name: 'Housing', icon: '🏠', subcategories: [
      _sc('sc_rent', 'Rent', '🏠'), _sc('sc_mortgage', 'Mortgage', '🏦'),
      _sc('sc_utilities', 'Utilities', '💡'), _sc('sc_homeinsurance', 'Home Insurance', '🛡️'),
      _sc('sc_maintenance', 'Maintenance', '🔧'),
      _sc('sc_dorm', 'Student Residence / Dorm Fees', '🏘️'), _sc('sc_deposit', 'Rental Deposit', '🔑'),
      _sc('sc_agencyfees', 'Agency & Contract Fees', '📄'), _sc('sc_electricity', 'Electricity', '⚡'),
      _sc('sc_gas', 'Gas & Heating', '🔥'), _sc('sc_water', 'Water', '💧'),
      _sc('sc_householdsupplies', 'Household & Cleaning Supplies', '🧽'), _sc('sc_laundry', 'Laundry', '🧺'),
      _sc('sc_localtax', 'Local / Housing Tax', '🏛️'), _sc('sc_moving', 'Moving Costs', '📦'),
      _sc('sc_furnishing', 'Furnishing & Bedding', '🛏️'), _sc('sc_utilityparking', 'Building Fees & Parking', '🅿️'),
    ] },
    { id: 'exp_food', name: 'Food & Groceries', icon: '🛒', subcategories: [
      _sc('sc_groceries', 'Groceries', '🛒'), _sc('sc_coffeesnacks', 'Coffee & Snacks', '☕'),
      _sc('sc_delivery', 'Delivery', '🛵'),
      _sc('sc_canteen', 'Campus Canteen / Cafeteria', '🍱'), _sc('sc_mealplan', 'Meal Plan', '🎟️'),
      _sc('sc_bakery', 'Bakery', '🥖'), _sc('sc_drinks', 'Drinks & Alcohol (Shop)', '🍷'),
      _sc('sc_mealkits', 'Meal Kits', '📦'), _sc('sc_lunchoutfood', 'Lunch on the Go', '🥪'),
      _sc('sc_specialtyfood', 'Specialty / Organic / Ethnic Food', '🥑'),
    ] },
    { id: 'exp_transport', name: 'Transport', icon: '🚗', subcategories: [
      _sc('sc_fuel', 'Fuel', '⛽'), _sc('sc_publictransport', 'Public Transport', '🚌'),
      _sc('sc_parking', 'Parking', '🅿️'), _sc('sc_carmaintenance', 'Car Maintenance', '🔧'),
      _sc('sc_ridehailing', 'Ride-hailing', '🚕'),
      _sc('sc_transitpass', 'Student Transit Pass', '🎫'), _sc('sc_train', 'Train', '🚆'),
      _sc('sc_longbus', 'Long-distance Bus', '🚍'), _sc('sc_bike', 'Bike Purchase & Repairs', '🚲'),
      _sc('sc_scooter', 'Bike / Scooter Sharing', '🛴'), _sc('sc_carinsurance', 'Car Insurance', '🛡️'),
      _sc('sc_roadtax', 'Road Tax & Registration', '📋'), _sc('sc_drivinglessons', 'Driving Lessons & Licence', '🚦'),
      _sc('sc_tolls', 'Tolls & Vignettes', '🛣️'), _sc('sc_carrental', 'Car Rental / Sharing', '🚙'),
    ] },
    { id: 'exp_restaurants', name: 'Restaurants', icon: '🍽️', subcategories: [
      _sc('sc_diningout', 'Dining Out', '🍽️'), _sc('sc_takeaway', 'Takeaway', '🥡'), _sc('sc_bars', 'Bars', '🍹'),
      _sc('sc_fastfood', 'Fast Food', '🍔'), _sc('sc_cafes', 'Cafés', '☕'), _sc('sc_brunch', 'Brunch & Bakery Cafés', '🥐'),
    ] },
    { id: 'exp_subscriptions', name: 'Subscriptions', icon: '📱', subcategories: [
      _sc('sc_streaming', 'Streaming', '📺'), _sc('sc_software', 'Software', '💻'),
      _sc('sc_memberships', 'Memberships', '🎫'), _sc('sc_news', 'News', '📰'),
      _sc('sc_music', 'Music', '🎧'), _sc('sc_cloud', 'Cloud Storage', '☁️'), _sc('sc_aitools', 'AI Tools', '🤖'),
      _sc('sc_gamingsub', 'Gaming Subscriptions', '🎮'), _sc('sc_studyapps', 'Study & Language Apps', '📖'),
      _sc('sc_vpn', 'VPN & Security', '🔒'), _sc('sc_shoppingmember', 'Shopping / Delivery Membership', '📦'),
      _sc('sc_audiobooks', 'Audiobooks & E-books', '🎙️'),
    ] },
    { id: 'exp_leisure', name: 'Entertainment', icon: '🎬', subcategories: [
      _sc('sc_movies', 'Movies', '🎬'), _sc('sc_concerts', 'Concerts', '🎵'),
      _sc('sc_games', 'Games', '🎮'), _sc('sc_hobbies', 'Hobbies', '🎨'),
      _sc('sc_nightlife', 'Nightlife & Clubs', '🪩'), _sc('sc_festivals', 'Festivals', '🎪'),
      _sc('sc_studentevents', 'Student Association Events & Parties', '🎉'), _sc('sc_sportsevents', 'Sports Events', '⚽'),
      _sc('sc_museums', 'Museums & Culture', '🏛️'), _sc('sc_clubsports', 'Sports Activities & Clubs', '🏐'),
      _sc('sc_boardgames', 'Board Games & Hobbies Gear', '🎲'), _sc('sc_leisurebooks', 'Books, Comics & Magazines', '📖'),
      _sc('sc_theatre', 'Theatre & Shows', '🎭'),
    ] },
    { id: 'exp_shopping', name: 'Shopping', icon: '🛍️', subcategories: [
      _sc('sc_clothing', 'Clothing', '👕'), _sc('sc_electronics', 'Electronics', '🔌'),
      _sc('sc_homegoods', 'Home Goods', '🛋️'),
      _sc('sc_shoes', 'Shoes', '👟'), _sc('sc_accessories', 'Accessories & Jewelry', '💍'),
      _sc('sc_sportswear', 'Sportswear & Gear', '🎽'), _sc('sc_phones', 'Phones & Accessories', '📱'),
      _sc('sc_computers', 'Computers & Tablets', '💻'), _sc('sc_techrepair', 'Repairs & Replacements', '🛠️'),
      _sc('sc_secondhand', 'Second-hand Purchases', '♻️'), _sc('sc_onlineshopping', 'Online Shopping', '📦'),
      _sc('sc_bags', 'Bags & Luggage', '🎒'), _sc('sc_headphones', 'Audio & Headphones', '🎧'),
    ] },
    { id: 'exp_health', name: 'Health', icon: '💊', subcategories: [
      _sc('sc_doctor', 'Doctor', '🩺'), _sc('sc_pharmacy', 'Pharmacy', '💊'),
      _sc('sc_healthinsurance', 'Insurance', '🛡️'), _sc('sc_fitness', 'Fitness', '🏋️'),
      _sc('sc_dentist', 'Dentist', '🦷'), _sc('sc_optician', 'Optician & Glasses', '👓'),
      _sc('sc_mentalhealth', 'Mental Health & Therapy', '🧠'), _sc('sc_vaccines', 'Vaccines', '💉'),
      _sc('sc_sexualhealth', 'Sexual Health & Contraception', '❤️‍🩹'), _sc('sc_hospital', 'Hospital & Emergency', '🏥'),
      _sc('sc_physio', 'Physiotherapy', '💆'), _sc('sc_supplements', 'Vitamins & Supplements', '💊'),
      _sc('sc_gym', 'Gym Membership', '🏋️'), _sc('sc_specialist', 'Specialist Consultations', '👩‍⚕️'),
    ] },
    { id: 'exp_bills', name: 'Bills', icon: '🧾', subcategories: [
      _sc('sc_phone', 'Phone', '📱'), _sc('sc_internet', 'Internet', '📶'),
      _sc('sc_mobiledata', 'Mobile Data & SIM', '📡'), _sc('sc_tvlicence', 'TV / Media Licence', '📺'),
      _sc('sc_postage', 'Postage & Shipping', '📮'), _sc('sc_billsother', 'Other Recurring Bills', '🧾'),
    ] },
    { id: 'exp_fees', name: 'Taxes & Fees', icon: '🏛️', subcategories: [
      _sc('sc_bankfees', 'Bank & Card Fees', '🏦'), _sc('sc_fxfees', 'Currency Exchange & Transfer Fees', '💱'),
      _sc('sc_atmfees', 'ATM Withdrawal Fees', '🏧'), _sc('sc_fines', 'Fines & Penalties', '⚠️'),
      _sc('sc_visa', 'Visa & Residence Permit', '🛂'), _sc('sc_adminfees', 'Administrative & Legal Fees', '📄'),
      _sc('sc_incometax', 'Income Tax', '🧾'), _sc('sc_latefees', 'Late Payment Fees', '⏰'),
      _sc('sc_notary', 'Documents, Translations & Notary', '📜'),
    ] },
    { id: 'exp_savings', name: 'Savings', icon: '💵', subcategories: [
      _sc('sc_emergencyfund', 'Emergency Fund', '🛟'), _sc('sc_investmentcontrib', 'Investment Contribution', '📈'),
      _sc('sc_travelfund', 'Travel Fund', '🧳'), _sc('sc_goalsavings', 'Goal Savings (Laptop, Deposit…)', '🎯'),
      _sc('sc_cryptobuy', 'Crypto Purchases', '🪙'), _sc('sc_pocketsavings', 'Transfer to Savings Account', '🏦'),
      _sc('sc_retirement', 'Retirement / Pension', '👴'),
    ] },
    { id: 'exp_travel', name: 'Travel', icon: '✈️', subcategories: [
      _sc('sc_flights', 'Flights', '✈️'), _sc('sc_hotels', 'Hotels', '🏨'), _sc('sc_activities', 'Activities', '🗺️'),
      _sc('sc_traintravel', 'Trains & Buses', '🚆'), _sc('sc_hostels', 'Hostels & Airbnb', '🛏️'),
      _sc('sc_travelinsurance', 'Travel Insurance', '🛡️'), _sc('sc_exchangecosts', 'Erasmus / Exchange Costs', '🎒'),
      _sc('sc_luggage', 'Luggage & Travel Gear', '🧳'), _sc('sc_roaming', 'Roaming & Travel SIM', '📶'),
      _sc('sc_triptransport', 'Local Transport on Trips', '🚇'), _sc('sc_tripfood', 'Food on Trips', '🍽️'),
      _sc('sc_gohome', 'Trips Home to Family', '🏡'), _sc('sc_travelvisa', 'Visas & Entry Fees', '🛂'),
    ] },
    { id: 'exp_education', name: 'Education', icon: '📚', subcategories: [
      _sc('sc_tuition', 'Tuition', '🎓'), _sc('sc_books', 'Books', '📚'), _sc('sc_courses', 'Courses', '🧑‍🏫'),
      _sc('sc_enrollment', 'Registration & Enrollment Fees', '📝'), _sc('sc_examfees', 'Exam & Resit Fees', '✏️'),
      _sc('sc_labmaterials', 'Lab & Course Materials', '🔬'), _sc('sc_stationery', 'Stationery & Supplies', '🖊️'),
      _sc('sc_printing', 'Printing & Copies', '🖨️'), _sc('sc_studysoftware', 'Software & Licences', '💻'),
      _sc('sc_studyequipment', 'Laptop & Study Equipment', '🖥️'), _sc('sc_languagecourses', 'Language Courses', '🌍'),
      _sc('sc_languagetests', 'Language Tests (IELTS, TOEFL…)', '✅'), _sc('sc_studentassoc', 'Student Association Membership', '🤝'),
      _sc('sc_fieldtrips', 'Field Trips & Excursions', '🚌'), _sc('sc_thesis', 'Thesis Printing & Binding', '📕'),
      _sc('sc_onlinecourses', 'Online Course Platforms', '🎓'), _sc('sc_studytutoring', 'Tutoring & Study Help', '🧑‍🏫'),
      _sc('sc_conferences', 'Conferences & Workshops', '🎤'), _sc('sc_graduation', 'Graduation Fees & Ceremony', '🎓'),
      _sc('sc_textbookrental', 'Textbook Rental', '📖'), _sc('sc_libraryfines', 'Library Fees & Fines', '🏛️'),
    ] },
    { id: 'exp_career', name: 'Work & Career', icon: '💼', subcategories: [
      _sc('sc_profclothes', 'Professional Clothing', '👔'), _sc('sc_networking', 'Networking Events', '🤝'),
      _sc('sc_certifications', 'Certifications & Training', '🏅'), _sc('sc_portfolio', 'CV, Portfolio & Website', '🌐'),
      _sc('sc_worktools', 'Work Tools & Equipment', '🧰'), _sc('sc_interviewtravel', 'Interview & Job-hunt Travel', '🚆'),
      _sc('sc_careerpremium', 'Career Platform Subscriptions', '🔗'),
    ] },
    { id: 'exp_insurance', name: 'Insurance', icon: '🛡️', subcategories: [
      _sc('sc_liability', 'Liability Insurance', '🛡️'), _sc('sc_deviceinsurance', 'Phone & Device Insurance', '📱'),
      _sc('sc_bikeinsurance', 'Bike Insurance', '🚲'), _sc('sc_legalprotection', 'Legal Protection', '⚖️'),
      _sc('sc_accidentlife', 'Accident / Life Insurance', '🩹'), _sc('sc_studentinsurance', 'Student Insurance Package', '🎓'),
    ] },
    { id: 'exp_debt', name: 'Debt & Loans', icon: '💳', subcategories: [
      _sc('sc_studentloanrepay', 'Student Loan Repayment', '🎓'), _sc('sc_creditcard', 'Credit Card Payment', '💳'),
      _sc('sc_personalloan', 'Personal Loan Repayment', '🏦'), _sc('sc_interestcharges', 'Interest & Finance Charges', '📉'),
      _sc('sc_overdraft', 'Overdraft Costs', '🔻'), _sc('sc_bnpl', 'Buy Now, Pay Later', '🛒'),
      _sc('sc_familyrepay', 'Repaying Family / Friends', '🤝'),
    ] },
    { id: 'exp_personalcare', name: 'Personal Care', icon: '💅', subcategories: [
      _sc('sc_haircare', 'Haircare', '💇'), _sc('sc_cosmetics', 'Cosmetics', '💄'), _sc('sc_spa', 'Spa', '💆'),
      _sc('sc_toiletries', 'Toiletries & Hygiene', '🧴'), _sc('sc_barber', 'Barber', '💈'),
      _sc('sc_nails', 'Nails & Beauty Treatments', '💅'), _sc('sc_skincare', 'Skincare', '🧼'),
      _sc('sc_drycleaning', 'Dry Cleaning & Tailoring', '🧵'),
    ] },
    { id: 'exp_social', name: 'Family & Social', icon: '🤝', subcategories: [
      _sc('sc_splitbills', 'Shared Costs with Friends / Flatmates', '🍕'), _sc('sc_lentfriends', 'Money Lent to Friends', '💸'),
      _sc('sc_familygiven', 'Support Given to Family', '👪'), _sc('sc_clubdues', 'Club & Society Dues', '🎽'),
      _sc('sc_pets', 'Pets', '🐾'), _sc('sc_partner', 'Partner / Dates', '💞'),
      _sc('sc_grouptrips', 'Group Events & Outings', '🎈'),
    ] },
    { id: 'exp_gifts', name: 'Gifts & Donations', icon: '🎁', subcategories: [
      _sc('sc_gifts', 'Gifts', '🎁'), _sc('sc_charity', 'Charity', '❤️'),
      _sc('sc_birthdaygifts', 'Birthday & Party Contributions', '🎂'), _sc('sc_holidaygifts', 'Holiday Gifts', '🎄'),
      _sc('sc_crowdfunding', 'Crowdfunding & Fundraisers', '🙌'), _sc('sc_tipping', 'Tips', '💁'),
    ] },
    { id: 'exp_other', name: 'Other', icon: '📦', subcategories: [
      _sc('sc_misc', 'Miscellaneous', '❔'), _sc('sc_unexpected', 'Unexpected / Emergency', '🚨'),
      _sc('sc_lostitems', 'Lost, Stolen or Damaged Items', '🔍'),
    ] },
  ],
};
